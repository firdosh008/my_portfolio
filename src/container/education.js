    ...
    return (
        <div className="p-24 ml-24 mt-10 education">
            ...
            <div className="grid grid-cols-2 pt-10 ">
                ...
                <div className="grid col-start-2 col-span-1 skill ">
                 <h2 className="text-5xl pt-10 w-fit h-fit ">My skills</h2>
                 <p className="row-start-2 row-span-1 text-xl">I'm a Freelancer MERN stack Developer with over 6 Month of experience. I code and create web elements for amazing people around the world. I like work with new people. New people new Experiences.</p>
